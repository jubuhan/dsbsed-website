...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 text-white/80 sticky bottom-0 z-0 transform-gpu will-change-transform">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 pb-4 md:pb-6">
        <div className="flex flex-col items-center gap-8 mb-12 md:mb-16">
          {/* Contact Button */}
          <div className="flex flex-col items-center">
            <h3 className="font-bold text-white text-base md:text-xl lg:text-2xl mb-8 text-center leading-relaxed md:leading-loose tracking-tight">
